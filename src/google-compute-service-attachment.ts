// https://www.terraform.io/docs/providers/google-beta/r/google_compute_service_attachment
...
export function googleComputeServiceAttachmentTimeoutsToTerraform(struct?: GoogleComputeServiceAttachmentTimeoutsOutputReference | GoogleComputeServiceAttachmentTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleComputeServiceAttachment extends cdktf.TerraformResource {
  ...
  */
  ...
  private _consumerAcceptLists = new GoogleComputeServiceAttachmentConsumerAcceptListsList(this, "consumer_accept_lists", false);
