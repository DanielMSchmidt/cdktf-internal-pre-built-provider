// https://www.terraform.io/docs/providers/google-beta/r/google_pubsub_subscription_iam_policy
...
export interface GooglePubsubSubscriptionIamPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class GooglePubsubSubscriptionIamPolicy extends cdktf.TerraformResource {
  ...
  * @param options GooglePubsubSubscriptionIamPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: GooglePubsubSubscriptionIamPolicyConfig) {
    super(scope, id, {
