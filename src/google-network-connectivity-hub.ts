// https://www.terraform.io/docs/providers/google-beta/r/google_network_connectivity_hub
...
export interface GoogleNetworkConnectivityHubRoutingVpcs {
}

export function googleNetworkConnectivityHubRoutingVpcsToTerraform(struct?: GoogleNetworkConnectivityHubRoutingVpcs): any {
...
export class GoogleNetworkConnectivityHubRoutingVpcsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleNetworkConnectivityHubRoutingVpcs | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: GoogleNetworkConnectivityHubRoutingVpcs | undefined) {
    if (value === undefined) {
...
export class GoogleNetworkConnectivityHubRoutingVpcsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): GoogleNetworkConnectivityHubRoutingVpcsOutputReference {
    return new GoogleNetworkConnectivityHubRoutingVpcsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function googleNetworkConnectivityHubTimeoutsToTerraform(struct?: GoogleNetworkConnectivityHubTimeoutsOutputReference | GoogleNetworkConnectivityHubTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GoogleNetworkConnectivityHubTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GoogleNetworkConnectivityHubTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleNetworkConnectivityHubTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GoogleNetworkConnectivityHub extends cdktf.TerraformResource {
  ...
  * @param options GoogleNetworkConnectivityHubConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleNetworkConnectivityHubConfig) {
    super(scope, id, {
  ...
  private _routingVpcs = new GoogleNetworkConnectivityHubRoutingVpcsList(this, "routing_vpcs", false);
  ...
  private _timeouts = new GoogleNetworkConnectivityHubTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleNetworkConnectivityHubTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleNetworkConnectivityHubTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
