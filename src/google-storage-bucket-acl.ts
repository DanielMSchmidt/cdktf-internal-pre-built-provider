// https://www.terraform.io/docs/providers/google-beta/r/google_storage_bucket_acl
...
*/
export class GoogleStorageBucketAcl extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleStorageBucketAclConfig) {
    super(scope, id, {
