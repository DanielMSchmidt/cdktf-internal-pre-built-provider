// https://www.terraform.io/docs/providers/google-beta/r/google_logging_organization_bucket_config
...
export class GoogleLoggingOrganizationBucketConfig extends cdktf.TerraformResource {
  ...
  * @param options GoogleLoggingOrganizationBucketConfigConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleLoggingOrganizationBucketConfigConfig) {
    super(scope, id, {
