// https://www.terraform.io/docs/providers/google-beta/r/google_compute_ssl_policy
...
export function googleComputeSslPolicyTimeoutsToTerraform(struct?: GoogleComputeSslPolicyTimeoutsOutputReference | GoogleComputeSslPolicyTimeouts | cdktf.IResolvable): any {
...
export class GoogleComputeSslPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeSslPolicyTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleComputeSslPolicyTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GoogleComputeSslPolicy extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: GoogleComputeSslPolicyConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GoogleComputeSslPolicyTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GoogleComputeSslPolicyTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: googleComputeSslPolicyTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
