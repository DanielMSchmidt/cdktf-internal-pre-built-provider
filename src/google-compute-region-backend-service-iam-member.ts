// https://www.terraform.io/docs/providers/google-beta/r/google_compute_region_backend_service_iam_member
...
export interface GoogleComputeRegionBackendServiceIamMemberConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: GoogleComputeRegionBackendServiceIamMemberCondition;
}
export interface GoogleComputeRegionBackendServiceIamMemberCondition {
  /**
...
export function googleComputeRegionBackendServiceIamMemberConditionToTerraform(struct?: GoogleComputeRegionBackendServiceIamMemberConditionOutputReference | GoogleComputeRegionBackendServiceIamMemberCondition): any {
...
export class GoogleComputeRegionBackendServiceIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleComputeRegionBackendServiceIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleComputeRegionBackendServiceIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class GoogleComputeRegionBackendServiceIamMember extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_compute_region_backend_service_iam_member";
  ...
  * @param options GoogleComputeRegionBackendServiceIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleComputeRegionBackendServiceIamMemberConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleComputeRegionBackendServiceIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleComputeRegionBackendServiceIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleComputeRegionBackendServiceIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
}
