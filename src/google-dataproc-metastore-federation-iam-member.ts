// https://www.terraform.io/docs/providers/google-beta/r/google_dataproc_metastore_federation_iam_member
...
export function googleDataprocMetastoreFederationIamMemberConditionToTerraform(struct?: GoogleDataprocMetastoreFederationIamMemberConditionOutputReference | GoogleDataprocMetastoreFederationIamMemberCondition): any {
...
export class GoogleDataprocMetastoreFederationIamMemberConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleDataprocMetastoreFederationIamMemberCondition | undefined {
  ...
  public set internalValue(value: GoogleDataprocMetastoreFederationIamMemberCondition | undefined) {
    if (value === undefined) {
...
export class GoogleDataprocMetastoreFederationIamMember extends cdktf.TerraformResource {
  ...
  * @param options GoogleDataprocMetastoreFederationIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleDataprocMetastoreFederationIamMemberConfig) {
    super(scope, id, {
  ...
  private _condition = new GoogleDataprocMetastoreFederationIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: GoogleDataprocMetastoreFederationIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: googleDataprocMetastoreFederationIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
}
