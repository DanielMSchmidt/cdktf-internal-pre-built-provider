...
export class GoogleFolderTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GoogleFolderTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GoogleFolderTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
